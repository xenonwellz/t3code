...
interface KimiSessionContext {
  ...
  /** While true, drop assistant stream notifications (deltas / assistant item lifecycle) after interrupt/cancel. */
  suppressAssistantOutput: boolean;
  stopped: boolean;
}
              ...
              Effect.gen(function* () {
                switch (event._tag) {
                  ...
                  case "AssistantItemStarted":
                    if (ctx.suppressAssistantOutput) {
                      return;
                    }
                    yield* offerRuntimeEvent(
                      makeAcpAssistantItemEvent({
